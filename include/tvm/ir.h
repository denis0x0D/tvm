...
/*! \brief Mark store/load with theirs bound.  */
constexpr const char* buffer_bound = "buffer_bound";
/*! \brief Allow to mark stores/loads with bound attributes.  */
constexpr const char *create_bound_attributes = "create_bound_attributes";
/*!
